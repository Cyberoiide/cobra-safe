# projects/gs15_projet_cobra/zkp.py
...
def authenticate_with_schnorr(username, password):
    ...
    # Dérivation de la clé privée depuis le mot de passe
    derived_key = int(derive_key(password), 16)
    s = derived_key % (p - 1)  # Clé privée dérivée
    ...
    print(f"[DEBUG] Vérification : left = {left}, right = {right}")
